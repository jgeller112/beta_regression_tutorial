...
fluency_data <- read.csv("https://raw.githubusercontent.com/jgeller112/beta_regression_tutorial/main/MS/data/miko_data.csv?token=GHSAT0AAAAAACUFWP2Q5XCML3W5EC77ZUSWZUYCIGA") %>%
...
#| label: tbl-zoib
#| echo: true
#| tbl-cap: "Model summary for the  zero-one inflated beta model"
#| tbl-cap-location: "top"
...
If we take a look at the summary output in @tbl-ordbeta-glmm, we can interpret the values similar to a beta regression.
