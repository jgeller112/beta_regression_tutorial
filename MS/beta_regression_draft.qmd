...
### Predicted probablities and marginal effects
...
We use the `bf` function to fit our four parameters. We use the native zero_one_inflated_beta family to fit our model.
