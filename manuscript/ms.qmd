...
While in this paper we will focus on proportions as bounded outcomes, it is important to note that our analysis applies to any bounded continuous scale. Any bounded continuous scale can be mapped to lie within 0 and 1 without resulting in a loss of information as the transformation is linear. Consequently, a scale that has natural end points of -1,234 and +8,451--or any other end points on the real number line short of infinity—can be modeled using the approaches we describe in this paper.
