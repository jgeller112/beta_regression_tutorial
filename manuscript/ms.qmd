...
combined_table_clean |>
  ...
  format_tt(escape = TRUE) |>
  save_tt(
    here::here("manuscript", "Figures", "combined_table.png"),
    overwrite = TRUE
  )
```
