...
Similarly, the dispersion parameter, which must be positive, is often modeled using a log link: \[ \log(\phi) = \text{linear predictor} \]. This ensures the estimated dispersion is strictly positive.
