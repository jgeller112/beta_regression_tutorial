...
[^7]: There is an additional version of this model, the zero-or-one-inflated Beta (ZOIB), which can accomodate discrete values at both the lower and upper limits of the scale with `brms`.
