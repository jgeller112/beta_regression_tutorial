...
In @tbl-ordbeta **the credible interval for the fluency difference is mostly positive with `r round(p_d$pd, 3)` % the posterior above zero, suggesting that fluent instructions probably yield somewhat higher accuracy than disfluent instructions after accounting for boundary responses, though the effect remains uncertain. In addition the 95% Cr.I is wide suggesting uncertainty about the effect.**
