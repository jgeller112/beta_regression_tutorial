...
Because the 95% credible interval for $\beta^{(\phi)}_{\text{FluencyFluent}}$ does not include zero, we infer that there is a difference in precision between the fluent and disfluent conditions is credible.
