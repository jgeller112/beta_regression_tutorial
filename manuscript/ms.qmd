...
pretty_table |>
  ...
  style_tt(
    i = c(2:3, 5:6, 8:9, 11:12, 14:15, 17:18, 20:21, 23:24, 26:27, 29:30, 32:33),
    italic = TRUE,
    fontsize = .6
  )
```
...
[^8]: Please note that there are other models available that can model this continuous process like the ordered beta model (
