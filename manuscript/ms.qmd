...
# All packages loaded once up front
packages <- c(
  "tidyverse", "easystats", "geomtextpath", "scales", "tinytable",
  "marginaleffects", "extraDistr", "brms", "posterior", "bayesplot",
  "ggdist", "patchwork", "cowplot", "gghalves", "posterior", "ggbeeswarm", "ggokabeito", "ordbetareg", 
  "here", "knitr", "cmdstanr", "webshot2"
)
purrr::walk(packages, library, character.only = TRUE)
options(scipen = 999, marginaleffects_posterior_center = mean)
set.seed(666)
```
...
fluency_data <- read.csv("https://raw.githubusercontent.com/jgeller112/beta_regression_tutorial/refs/heads/main/manuscript/data/fluency_data.csv?token=GHSAT0AAAAAADGFWDDEGP3PKLA26WYDLYG62DFKN3Q")
```
