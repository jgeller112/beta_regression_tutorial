...
#| message: false
#| warning: false
packages <- c("tidyverse", "easystats", "scales", "tinytable", "marginaleffects","cowplot", "ggbeeswarm", "gghalves", "extraDistr", "brms", "posterior", "bayesplot", "ggdist")
```
...
combined_table_clean <- combined_table %>%
  mutate(
    value = str_glue("{Mean} {`95% Cr.I`}<br>(pd = {pd})")
  ) |>
