...
#| tbl-cap: Predicted probabilities for fluency factor ($\mu$).
...
#| lst-cap: Calculating the difference between probabilities ($\mu$) for fluency with `avg_comparisons()`
#| echo: true
...
model1 <- read_rds(here("models", "model_reg_bayes.rds"))
model2 <- read_rds(here("models", "model_beta_bayes_dis_run01.rds"))
model3 <- read_rds(here("models", "bayes_zib_model0not1.rds"))
model4 <- read_rds(here("models", "bayes_zoib_model.rds"))
model5 <- read_rds(here("models", "bayes_ordbeta_phi_model.rds"))
```
