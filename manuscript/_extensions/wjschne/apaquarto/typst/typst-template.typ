...
#let man(
  ...
  set par.line(numbering: "1") if numberedlines
  ...
  show figure.where(kind: "quarto-float-tbl"): it => block(width: 100%, breakable: false)[
    #align(left)[
      #if int(appendixcounter.display().at(0)) > 0 [
...
// documentmode: doc (single-column, single-spaced, compact;
// mirrors apa7.cls doc option)
#let doc(
  title: none,
  runninghead: none,
  margin: (x: 1in, y: 1in),
